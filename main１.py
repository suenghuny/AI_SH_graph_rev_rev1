...
if __name__ == "__main__":
    ...
    for e in range(num_iteration):
        ...
        if e % 10 == 0:
            ...
            df.to_csv(output_dir + 'episode_reward１.csv')
            ...
            df_eval_lose.to_csv(output_dir + 'eval_lose１.csv')
            df_eval_win.to_csv(output_dir + 'eval_win１.csv')
            df_lose.to_csv(output_dir+'lose_ratio１.csv')
            df_win.to_csv(output_dir+'win_ratio１.csv')
        if e % 200 == 0:
