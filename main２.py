...
if __name__ == "__main__":
    ...
    for e in range(num_iteration):
        ...
        if e % 10 == 0:
            ...
            df.to_csv(output_dir + 'episode_reward２.csv')
            ...
            df_eval_lose.to_csv(output_dir + 'eval_lose２.csv')
            df_eval_win.to_csv(output_dir + 'eval_win２.csv')
            df_lose.to_csv(output_dir+'lose_ratio２.csv')
            df_win.to_csv(output_dir+'win_ratio２.csv')
        if e % 200 == 0:
