    ...
    def preprocessing(self, input_path):
        if self.mode != 'txt':
            ...
            ship_data = ship_data.astype({'speed': 'float64', 'course': 'float64', 'surface_tracking_limit': 'int64',
                                          ...
                                          'air_engagement_limit': 'int64', 'evading_course': 'float64',
                                          'type_m_sam': 'int64', 'num_m_sam': 'int64',
                                          'type_l_sam': 'int64', 'num_l_sam': 'int64', 'type_ssm': 'int64',
                                          'num_ssm': 'int64',
                                          'decoy_launching_bearing': 'float64', 'decoy_launching_distance': 'float64',
                                          'decoy_launching_interval': 'float64', 'decoy_rcs': 'float64',
                                          'decoy_duration': 'float64',
                                          'decoy_decaying_rate': 'float64', 'length': 'float64', 'breadth': 'float64',
                                          'height': 'float64', 'detection_range': 'float64',
                                          'radar_peak_power': 'float64', 'antenna_gain_factor': 'float64',
                                          'wavelength_of_signal': 'float64',
                                          'radar_receiver_bandwidth': 'float64', 'ciws_max_range': 'float64',
                                          'ciws_max_num_per_min': 'float64',
                                          'ciws_bullet_capacity': 'float64', 'ssm_launching_duration_min': 'float64',
                                          'ssm_launching_duration_max': 'float64',
                                          'lsam_launching_duration_min': 'float64',
                                          'lsam_launching_duration_max': 'float64',
                                          'msam_launching_duration_min': 'float64',
            ...
            patrol_aircraft_data = patrol_aircraft_data.astype(
                {'speed': 'float64', 'course': 'float64', 'radius': 'float64', 'side': 'string'})
