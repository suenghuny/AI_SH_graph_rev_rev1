...
def simulation(solution, ga = True):
    ...
    for e in range(n):
        ...
        epi_reward, eval, win_tag= evaluation(env, temperature1=temperature1,temperature2 = temperature2,enemy_ship_normalizer_blue = enemy_ship_normalizer_blue)
        if win_tag != 'lose':
            score += 1/n
        else:
            score += 0
...
if __name__ == "__main__":
    ...
    for dataset in datasets:
        ...
        df_fit.to_csv('fitness_records_dataset{}_rule6_param2.csv'.format(dataset))
        ...
        df_result.to_csv("GA_result_rule6_param2.csv")
